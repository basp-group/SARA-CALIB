...
param_im.En_lev = [10, 10, 1e-5] ; % energy of each level
param_im.rho = 0.1 ; % percentage for std deviation: std_lev = rho * moy_lev
else
param_im.kappa = 0.5 ; % ratio for energy unknown image/approximated image
end
% -----------------------------------------
param_im.min = 0 ;
param_im.max = +Inf ;
